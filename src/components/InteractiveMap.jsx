...
const defaultIcons = {
  ...
  eatery: createCustomIcon("https://cdn-icons-png.flaticon.com/128/16455/16455487.png"),
...
const placesData = [
  ...
  },
  {
    ...
    nearbyAttractions: [
      { id: 103, name: "Ton Mang Klang Na Camping", position: [19.159880, 101.158347], type: "attraction", distance: 1.1, image: "https://scontent.fbkk6-1.fna.fbcdn.net/v/t39.30808-6/348703339_737363335062481_2042458407198846152_n.jpg?stp=cp6_dst-jpg_tt6&_nc_cat=108&ccb=1-7&_nc_sid=cc71e4&_nc_eui2=AeGyBNJYuV5K9aOUx-C4CI7OzO5V71DbvQPM7lXvUNu9A7Jf429KZYJOZge3Id9OnCw&_nc_ohc=2bWP--d09nUQ7kNvgERMGDo&_nc_oc=AdmZGiNbA7gygvgeP-tr_gGKz_8PArbejDlRUu5L1j0A0C_pzVpeCugujVOjxa2Onf0&_nc_zt=23&_nc_ht=scontent.fbkk6-1.fna&_nc_gid=tNYUjdfYT4De4GYisYKY7A&oh=00_AYHngwdAeESy9O0ftDB4denm-4Q5jTjYYPn5kJDurogasQ&oe=67E2A6E3" },
      { id: 104, name: "Baanna Kham Salt Maker", position: [19.149452, 101.157014], type: "attraction", distance: 1.8, image: "https://resource.nationtv.tv/resource/photo_news/2021/02/15/640_5jfbe6abd658aeh6a6j5b.jpg?x-image-process=style/lg-webp" },
    ],
    nearbyPlaces: [
      { id: 203, name: "Bo Kluea Hospital", type: "hospital", price: "n/a", rating: 4.2, views: 12 },
      { id: 204, name: "Bo Kluea District Office", type: "default", price: "n/a", rating: 3.9, views: 9 },
    ]
  },
  {
    id: 4,
    ...
    nearbyAttractions: [
      { id: 103, name: "Baan Kru Kai Fabric Weave", position: [18.756747, 100.791868], type: "attraction", distance: 0.5, image: "https://mpics.mgronline.com/pics/Images/559000004113801.JPEG" },
      { id: 104, name: "Baan Nam Ngeiw", position: [18.754629, 100.790222], type: "eatery", distance: 1.7, image: "https://img.wongnai.com/p/1968x0/2018/11/04/3ceccd73b8574f6da21e37203f62e714.jpg" },
    ],
    nearbyPlaces: [
      { id: 203, name: "Bo Kluea Hospital", type: "hospital", price: "n/a", rating: 4.2, views: 12 },
      { id: 204, name: "Bo Kluea District Office", type: "default", price: "n/a", rating: 3.9, views: 9 },
  ...
  return (
    <div className={`flex flex-col ${isMobile ? '' : 'flex-row'} h-screen`}>
      ...
      {selectedPlace && (
        <div 
          ref={sidebarRef}
          className="sidebar bg-white shadow-lg overflow-y-auto"
          style={{ 
